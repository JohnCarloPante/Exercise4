...
if (isset($_POST['Confirm'])) {
    ...
    if ($ID !== NULL) {
        $query = "UPDATE accounts SET Username = $new_Username, Password = '$new_Password' , WHERE ID = $ID";
        $result = mysqli_query($conn, $query);
...
<div class="float-container">
    ...
    <div class="float-header">
        <div class = "button-container">
            <h4 class = "loginbot"><a onclick="document.getElementById('id01').style.display='block'" style="width:auto;" name="Login" >Login</a></h4>
...
<div id="id01" class="modal" <?php if ($keep_modal_open) echo 'style="display:block;"'; ?>>
...
$action_url = htmlspecialchars($_SERVER["PHP_SELF"]);
?>
<div id="id02" class="modal" <?php if ($keep_modal_open) echo 'style="display:block;"'; ?>>
  ...
  <form class="modal-content" action="<?php ($_SERVER["PHP_SELF"]); ?>" method="POST">
    <div class="container">
      ...
      <input type="text" placeholder="Edit Username" name="email" required>
      ...
      <br>
      <textarea id= "desc" rows="10" cols="150" ><?php echo htmlspecialchars($Description_Placeholder); ?></textarea id= "desc" rows="3 " cols="50">
